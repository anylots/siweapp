          ...
          <div className="p-3 text-center">
            ...
            <button
              className="btn btn-primary" style={{
                width: "120px",
                position: "absolute", "border-radius": "100px", "-webkit-font-smoothing": "antialiased", fontFamily: "Montserrat",
                top: "13px", "fontSize": "16px", marginLeft: "", color: "#ffffffbb", background: "linear-gradient(44.19deg,#1c7bff -.88%,#9d6fff 97.74%)"
              }}
              type="button"
              onClick={() => this.connectWallet()}
            >
              <span style={{ whiteSpace: "nowrap" }}>{this.state.buttonText}</span>
            </button>
          </div>
        </div>
      </div>
